...
with DAG(
  ...
  hw_7_write_to_mysql = BashOperator(
    task_id='hw_7_write_to_mysql',
    bash_command='export SPARK_HOME=/home/spark && export PATH=$PATH:$SPARK_HOME/bin:$SPARK_HOME/sbin && python3 /home/airflow/dags/s7_hw_wtm.py',
  )
  
  hw_7_get_temperature_task >> hw_7_check_temperature_task >> [hw_7_print_warm, hw_7_print_cold] >> hw_7_write_to_mysql
